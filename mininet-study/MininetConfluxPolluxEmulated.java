...
public class MininetConfluxPolluxEmulated extends ModelInterface{
	public MininetConfluxPolluxEmulated(Database db, Experiment exp) {
	...
	public INet buildModel(Map<String, ModelParamValue> parameters) {
		...
		portaltoPh_interface.setIpAddress("10.1.0.28");
		portaltoPh_interface.addReachableNetwork("192.168.0.0/16");
