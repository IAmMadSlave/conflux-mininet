...
public class MininetConfluxCastorEmulated extends ModelInterface{
	public MininetConfluxCastorEmulated(Database db, Experiment exp) {
	...
	public INet buildModel(Map<String, ModelParamValue> parameters) {
		...
		portaltoPh_interface.setIpAddress("10.1.0.29");
		portaltoPh_interface.addReachableNetwork("192.170.0.0/16");
