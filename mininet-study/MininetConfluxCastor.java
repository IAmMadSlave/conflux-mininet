...
public class MininetConfluxCastor extends ModelInterface{
	public MininetConfluxCastor(Database db, Experiment exp) {
	...
	public INet buildModel(Map<String, ModelParamValue> parameters) {
		...
		portaltoPh_interface.setIpAddress("10.10.3.1");
		portaltoPh_interface.addReachableNetwork("10.10.2.0/24");	
