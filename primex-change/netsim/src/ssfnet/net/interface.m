...
class Interface: public ConfigurableEntity<Interface, BaseInterface, 0, "Iface"> {
	...
	state_configuration {
        ...
        configurable int arrival_symbio_bytes {
			type= INT;
			default_value="0";
			doc_string="arrival_symbio_bytes";
			visualized=true;
			statistic=true;
		};
        
        configurable int arrival_symbio_packets {
			type= INT;
			default_value="0";
			doc_string="arrival_symbio_packets";
			visualized=true;
			statistic=true;
		};
...
#if SYMBIOTIC
    /** Get # symbio bytes arrived */
	int getSymbioBytes();
    
    /** Get # symbio packets arrived */
	int getSymbioPackets();
#endif
