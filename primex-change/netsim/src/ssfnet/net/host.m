...
private:
	...
	Community* community;
#if SYMBIOTIC
    SSFNET_MAP(int, bool) symbio_id_sender;
#endif
public:
	/** The constructor. */
	Host();
...
#if SYMBIOTIC
    /** Return the symbio traffic map (id-sender) this host has. */
	SSFNET_MAP(int, bool) getSymbioMap();
#endif
	...
	/** Return the bitrate of the first (connected) interface. */
	float getDefaulBitrate();
