...
enum ProtocolType {
  ...
  /** Used for STCP*/
  SSFNET_PROTOCOL_TYPE_STCP_CLIENT = 216,
  SSFNET_PROTOCOL_TYPE_STCP_SERVER = 217,

  /** Used for Generic*/
  SSFNET_PROTOCOL_TYPE_GENERIC_CLIENT = 218,
  SSFNET_PROTOCOL_TYPE_GENERIC_SERVER = 219,

  /** Used for SUDP*/
  SSFNET_PROTOCOL_TYPE_SUDP_CLIENT = 220,
  SSFNET_PROTOCOL_TYPE_SUDP_SERVER = 221,

  SSFNET_PROTOCOL_TYPE_MY_NEW_APP = 222,
  SSFNET_PROTOCOL_TYPE_MY_NEW_APP_SENDER = 223,
};
